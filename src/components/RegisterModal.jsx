...
const RegisterModal = ( {onClose}) => {
    ...
    return (
        <div className="relative z-10" aria-labelledby="modal-title" role="dialog" aria-modal="true">
            <div className="fixed inset-0 bg-gray-500 bg-opacity-75 transition-opacity" onClick={testClose}></div>
                            ...
                            <div className="sm:flex sm:items-start">
                                ...
                                <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                    ...
                                    <div className="mt-2">
                                        ...
                                        />
                                        {validationErrors.firstname && <div className="text-red-600 font-montserrat font-semibold">{validationErrors.firstname}</div>}
                                        ...
                                        />
                                        {validationErrors.lastname && <div className="text-red-600 font-montserrat font-semibold">{validationErrors.lastname}</div>}
                                        ...
                                        <input
                                            ...
                                            className="sm:w-[400px] w-[300px] px-3 py-2 border border-gray-300 rounded-md"
                                        />
                                        {validationErrors.email && <div className="text-red-600 font-montserrat font-semibold">{validationErrors.email}</div>}
                                        ...
                                        {validationErrors.dateOfBirth && <div className="text-red-600 font-montserrat font-semibold">{validationErrors.dateOfBirth}</div>}
                                        ...
                                        <input
                                            ...
                                            className="sm:w-[400px] w-[300px] px-3 py-2 border border-gray-300 rounded-md"
                                        />
                                        {validationErrors.phone && <div className="text-red-600 font-montserrat font-semibold">{validationErrors.phone}</div>}
                                        ...
                                        <input
                                            ...
                                            className="sm:w-[400px] w-[300px] px-3 py-2 border border-gray-300 rounded-md"
                                        />
                                        {validationErrors.password && <div className="text-red-600 font-montserrat font-semibold">{validationErrors.password}</div>}
                                    </div>
                                </div>
                            </div>
                        </div>
